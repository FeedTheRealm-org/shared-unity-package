...
namespace Assets.HeroEditor4D.Common.Scripts.Common
{
    public static class StandaloneFilePicker
    {
        ...
        public static IEnumerator OpenFile(
            string title,
            string directory,
            string extension,
        ...
        public static IEnumerator SaveFile(
            string title,
            string directory,
            string defaultName,
            string extension,
        ...
        )
        {
            throw new NotImplementedException(
                "Import [Simple File Browser For Windows]: http://u3d.as/2QLg"
            );
        ...
        )
        {
            ...
            SimpleFileBrowserForWebGL.WebFileBrowser.Upload(
                (fileName, mime, bytes) => callback(true, null, bytes),
                extension
            );
            ...
            throw new NotImplementedException(
                "Import [Simple File Browser for WebGL]: http://u3d.as/2W52"
            );

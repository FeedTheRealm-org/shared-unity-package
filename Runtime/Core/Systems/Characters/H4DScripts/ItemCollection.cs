...
namespace Assets.HeroEditor4D.InventorySystem.Scripts
{
    ...
    public class ItemCollection : ScriptableObject
    {
        ...
        {
            if (GetItemParamsOverride != null)
                return GetItemParamsOverride(item);
        ...
        {
            if (GetBackgroundCustom != null)
                return GetBackgroundCustom(item) ?? BackgroundBrown;

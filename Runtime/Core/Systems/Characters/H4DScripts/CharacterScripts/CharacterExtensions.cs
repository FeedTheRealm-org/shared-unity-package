    ...
    public static class CharacterExtensions
    {
        ...
        public static void Randomize(this Character4D character)
        {
            ...
            if (character.Front.SpriteCollection.Hair.Count > 0)
                character.SetBody(
                    character.Front.SpriteCollection.Hair.Random(),
                    BodyPart.Hair,
                    RandomColor
                );
            if (character.Front.SpriteCollection.Eyebrows.Count > 0)
                character.SetBody(
                    character.Front.SpriteCollection.Eyebrows.Random(),
                    BodyPart.Eyebrows
                );
            if (character.Front.SpriteCollection.Eyes.Count > 0)
                character.SetBody(
                    character.Front.SpriteCollection.Eyes.Random(),
                    BodyPart.Eyes,
                    RandomColor
                );
            ...
            switch (Random.Range(0, 5))
            {
                case 0:
                    character.Equip(
                        character.Front.SpriteCollection.MeleeWeapon1H.Random(),
                ...
                case 1:
                    ...
                    character.Equip(
                        character.Front.SpriteCollection.Shield.Random(),
                        EquipmentPart.Shield
                    );
                    break;
                case 2:
                    character.Equip(
                        character.Front.SpriteCollection.MeleeWeapon2H.Random(),
                        EquipmentPart.MeleeWeapon2H
                    );
                    break;
                case 3:
                    character.Equip(
                        character.Front.SpriteCollection.Bow.Random(),
                        EquipmentPart.Bow
                    );
                    break;
                case 4:
                    character.Equip(
                        character.Front.SpriteCollection.Firearm1H.Random(),

...
namespace Assets.HeroEditor4D.Common.Scripts.CharacterScripts
{
    ...
    public class Character4D : MonoBehaviour
    {
        ...
        public List<Sprite> Head
        {
            ...
            {
                Parts.ForEach(i =>
                    i.Head = i.HairRenderer.GetComponent<SpriteMapping>().FindSprite(value)
                );
            }
        }
        public List<Sprite> Hair
        {
            ...
            {
                Parts.ForEach(i =>
                    i.Hair = i.HairRenderer.GetComponent<SpriteMapping>().FindSprite(value)
                );
            }
        }
        public List<Sprite> Beard
        {
            set
            {
                ...
                {
                    if (i.BeardRenderer)
                        i.Beard = i.BeardRenderer.GetComponent<SpriteMapping>().FindSprite(value);
                });
            }
        }
        ...
        public List<Sprite> Eyebrows
        {
            set
            {
                PartsExceptBack.ForEach(i =>
                    i.Expressions[0].Eyebrows = i
                        .EyebrowsRenderer.GetComponent<SpriteMapping>()
                        .FindSprite(value)
                );
            }
        }
        public List<Sprite> Eyes
        {
            ...
            {
                PartsExceptBack.ForEach(i =>
                    i.Expressions[0].Eyes = i
                        .EyesRenderer.GetComponent<SpriteMapping>()
                        .FindSprite(value)
                );
            }
        }
        public List<Sprite> Mouth
        {
            ...
            {
                PartsExceptBack.ForEach(i =>
                    i.Expressions[0].Mouth = i
                        .MouthRenderer.GetComponent<SpriteMapping>()
                        .FindSprite(value)
                );
            }
        }
        public List<Sprite> Helmet
        {
            ...
            {
                Parts.ForEach(i =>
                    i.Helmet = i.HelmetRenderer.GetComponent<SpriteMapping>().FindSprite(value)
                );
            }
        }
        ...
        public List<Sprite> Makeup
        {
            set
            {
                ...
                {
                    if (i.MakeupRenderer)
                        i.Makeup = i.MakeupRenderer.GetComponent<SpriteMapping>().FindSprite(value);
                });
            }
        }
        public List<Sprite> Mask
        {
            set
            {
                ...
                {
                    if (i.MaskRenderer)
                        i.Mask = i.MaskRenderer.GetComponent<SpriteMapping>().FindSprite(value);
                });
            }
        }
        ...
        public void Start()
        {
            var stateHandler = Animator
                .GetBehaviours<StateHandler>()
        ...
        private void UpdateWeaponType(EquipmentPart part)
        {
            switch (part)
            {
                ...
                case EquipmentPart.MeleeWeapon2H:
                    Animator.SetInteger("WeaponType", (int)WeaponType.Melee2H);
                    break;
                case EquipmentPart.Bow:
                    Animator.SetInteger("WeaponType", (int)WeaponType.Bow);
                    break;
                case EquipmentPart.Crossbow:
                    Animator.SetInteger("WeaponType", (int)WeaponType.Crossbow);
                    break;
                case EquipmentPart.Firearm1H:
                    Animator.SetInteger("WeaponType", (int)WeaponType.Firearm1H);
                    break;
                case EquipmentPart.Firearm2H:
                    Animator.SetInteger("WeaponType", (int)WeaponType.Firearm2H);
                    break;
                case EquipmentPart.SecondaryFirearm1H:
                    Animator.SetInteger("WeaponType", (int)WeaponType.Paired);
                    break;
            }
        }
        ...
        public void SetDirection(Vector2 direction)
        {
            ...
            if (Direction == Vector2.zero)
            {
                ...
                Parts[0].transform.localPosition = Shadows[0].transform.localPosition = new Vector3(
                    0,
                    -1.25f
                );
                Parts[1].transform.localPosition = Shadows[1].transform.localPosition = new Vector3(
                    0,
                    1.25f
                );
                Parts[2].transform.localPosition = Shadows[2].transform.localPosition = new Vector3(
                    -1.5f,
                    0
                );
                Parts[3].transform.localPosition = Shadows[3].transform.localPosition = new Vector3(
                    1.5f,
                    0
                );
        ...
        public void CopyFrom(Character4D character)
        {
            for (var i = 0; i < Parts.Count; i++)
            {
                ...
                Parts[i].AnchorFireMuzzle.localPosition = character
                    .Parts[i]
                    .AnchorFireMuzzle
                    .localPosition;
            }
        ...
        {
            Equip(
                SpriteCollection.MeleeWeapon1H.SingleOrDefault(i => i.Id == item.Params.SpriteId),
        ...
        public void EquipArmor(Item item)
        {
            if (item == null)
                ...
                Equip(
                    SpriteCollection.Armor.Single(i => i.Id == item.Params.SpriteId),
                    EquipmentPart.Armor
                );
        }
        ...
        {
            Equip(
                SpriteCollection.Shield.SingleOrDefault(i => i.Id == item.Params.SpriteId),
        ...
        {
            Equip(
                SpriteCollection.MeleeWeapon2H.SingleOrDefault(i => i.Id == item.Params.SpriteId),
        ...
        {
            Equip(
                SpriteCollection.Bow.SingleOrDefault(i => i.Id == item.Params.SpriteId),
                EquipmentPart.Bow
            );
        }
        ...
        {
            Equip(
                SpriteCollection.Crossbow.SingleOrDefault(i => i.Id == item.Params.SpriteId),
        ...
        {
            Equip(
                SpriteCollection.Firearm1H.SingleOrDefault(i => i.Id == item.Params.SpriteId),

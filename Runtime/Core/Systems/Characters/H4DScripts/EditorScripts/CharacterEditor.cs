...
namespace Assets.HeroEditor4D.Common.Scripts.EditorScripts
{
    ...
    public class CharacterEditor : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            ItemCollection.Active.SpriteCollections = new List<SpriteCollection>
            {
                SpriteCollection,
            };
        ...
        public void OnSelectTab(bool value)
        {
            ...
            List<ItemSprite> SortByCollection(List<ItemSprite> collection)
            {
                return collection
                    .OrderBy(i =>
                        CollectionSorting.Contains(i.Collection)
                            ? CollectionSorting.IndexOf(i.Collection)
                            : 999
                    )
                    .ThenBy(i => i.Id)
                    .ToList();
            ...
            switch (tab.name)
            {
                case "Armor":
                {
                    ...
                    ItemCollection.Active.Items = sprites
                        .Select(i => CreateFakeItemParams(new Item(i.Id), i))
                        .ToList();
                    equipAction = item => Character.Equip(item.Sprite, EquipmentPart.Armor);
                    equippedIndex =
                        Character.Front.Armor == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.Contains(
                                    Character.Front.Armor.SingleOrDefault(j =>
                                        j.name == "FrontBody"
                                    )
                                )
                            );
                ...
                case "Helmet":
                {
                    ...
                    ItemCollection.Active.Items = sprites
                        .Select(i => CreateFakeItemParams(new Item(i.Id), i, ".Armor.", ".Helmet."))
                        .ToList();
                    equipAction = item => Character.Equip(item.Sprite, EquipmentPart.Helmet);
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Helmet)
                    );
                    break;
                }
                case "Vest":
                ...
                case "Leggings":
                {
                    ...
                    switch (tab.name)
                    {
                        ...
                        case "Leggings":
                            ...
                            break;
                        default:
                            throw new NotSupportedException(tab.name);
                    }
                    ...
                    ItemCollection.Active.Items = sprites
                        .Select(i =>
                            CreateFakeItemParams(new Item(i.Id), i, ".Armor.", $".{tab.name}.")
                        )
                        .ToList();
                    equipAction = item =>
                        Character.Equip(item.Sprite, tab.name.ToEnum<EquipmentPart>());
                    equippedIndex =
                        Character.Front.Armor == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.Contains(
                                    Character.Front.Armor.SingleOrDefault(j => j.name == part)
                                )
                            );
                    break;
                }
                case "Shield":
                {
                    ...
                    equippedIndex =
                        Character.Front.Shield == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.SequenceEqual(Character.Front.Shield)
                            );
                    break;
                }
                case "Back":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Back)
                    );
                    break;
                }
                case "Wings":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Wings)
                    );
                    break;
                }
                case "Melee1H":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.PrimaryWeapon)
                    );
                    break;
                }
                case "Melee2H":
                ...
                case "MeleePaired":
                {
                    ...
                    ItemCollection.Active.Items = sprites
                        ...
                        .ToList();
                    equipAction = item =>
                        Character.Equip(item.Sprite, EquipmentPart.SecondaryMelee1H);
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.SecondaryWeapon)
                    );
                    break;
                }
                case "Bow":
                {
                    ...
                    equippedIndex =
                        Character.Front.CompositeWeapon == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.SequenceEqual(Character.Front.CompositeWeapon)
                            );
                    break;
                }
                case "Crossbow":
                ...
                case "Firearm1H":
                {
                    ...
                    equippedIndex =
                        Character.Front.SecondaryWeapon == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.Contains(Character.Front.PrimaryWeapon)
                            );
                ...
                case "Firearm2H":
                {
                    ...
                    equippedIndex =
                        Character.Front.PrimaryWeapon == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.Contains(Character.Front.PrimaryWeapon)
                            );
                ...
                case "SecondaryFirearm1H":
                {
                    ...
                    ItemCollection.Active.Items = sprites
                        ...
                        .ToList();
                    equipAction = item =>
                        Character.Equip(item.Sprite, EquipmentPart.SecondaryFirearm1H);
                    equippedIndex =
                        Character.Front.SecondaryWeapon == null
                            ? -1
                            : sprites.FindIndex(i =>
                ...
                case "Eyebrows":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Expressions[0].Eyebrows)
                    );
                    break;
                }
                case "Eyes":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Expressions[0].Eyes)
                    );
                    break;
                }
                case "Hair":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Hair)
                    );
                    break;
                }
                case "Beard":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Beard)
                    );
                    break;
                }
                case "Mouth":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Expressions[0].Mouth)
                    );
                    break;
                }
                case "Makeup":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Makeup)
                    );
                    break;
                }
                case "Mask":
                {
                    ...
                    equipAction = item =>
                        Character.Equip(
                            item.Sprite,
                            EquipmentPart.Mask,
                            item.Sprite != null && item.Sprite.Tags.Contains("Paint")
                                ? null
                                : Color.white
                        );
                    equippedIndex = sprites.FindIndex(i =>
                        i.Sprites.Contains(Character.Front.Mask)
                    );
                    break;
                }
                case "Earrings":
                {
                    ...
                    equippedIndex =
                        Character.Front.Earrings == null
                            ? -1
                            : sprites.FindIndex(i =>
                                i.Sprites.SequenceEqual(Character.Front.Earrings)
                            );
                    break;
                }
                case "Supplies":
        ...
        private ItemParams CreateFakeItemParams(
            Item item,
        ...
        )
        {
            ...
            return new ItemParams
            {
                ...
                SpriteId = spriteId,
                Rarity = rarity,
                Meta = itemSprite == null ? null : JsonConvert.SerializeObject(itemSprite.Tags),
            };
        }
        ...
        public void SaveToJson()
        {
            StartCoroutine(
                StandaloneFilePicker.SaveFile(
                    ...
                    (success, path) =>
                    {
                        Debug.Log(success ? $"Saved as {path}" : "Error saving.");
                    }
                )
            );
        }
        ...
        public void LoadFromJson()
        {
            StartCoroutine(
                StandaloneFilePicker.OpenFile(
                    ...
                    {
                        if (success)
                            Character.FromJson(Encoding.Default.GetString(bytes), silent: false);
                    }
                )
            );
        }
        ...
        public void Save()
        {
            var path = UnityEditor.EditorUtility.SaveFilePanel(
                "Save character prefab (should be inside Assets folder)",
                _path,
                "New character",
                "prefab"
            );
        ...
        public void Paint(Color color)
        {
            foreach (var part in ResolveParts(ActiveTab.name))
            {
                part.color = color;
                part.sharedMaterial =
                    color == Color.white ? DefaultMaterial
                    : ActiveTab.name == "Eyes" ? EyesPaintMaterial
                    : EquipmentPaintMaterial;
            }
        ...
        public void SetupColor(float h, float s, float v)
        {
            ...
            foreach (var part in ResolveParts(ActiveTab.name))
            {
                ...
                {
                    var huePaint =
                        part.GetComponent<HuePaint>() ?? part.gameObject.AddComponent<HuePaint>();
        ...
        protected List<SpriteRenderer> ResolveParts(string target)
        {
            ...
            {
                case "Helmet":
                    return Character.Parts.Select(i => i.HelmetRenderer).ToList();
                case "Ears":
                    return Character.Parts.SelectMany(i => i.EarsRenderers).ToList();
                case "Body":
                    return Character
                        .Parts.SelectMany(i =>
                            i.BodyRenderers.Union(new List<SpriteRenderer> { i.HeadRenderer })
                                .Union(i.EarsRenderers)
                        )
                        .ToList();
                case "Head":
                    return Character.Parts.Select(i => i.HeadRenderer).ToList();
                case "Hair":
                    return Character.Parts.Select(i => i.HairRenderer).ToList();
                case "Beard":
                    return Character
                        .Parts.Select(i => i.BeardRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Eyes":
                    return Character
                        .Parts.Select(i => i.EyesRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Eyebrows":
                    return Character
                        .Parts.Select(i => i.EyebrowsRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Mouth":
                    return Character
                        .Parts.Select(i => i.MouthRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Mask":
                    return Character
                        .Parts.Select(i => i.MaskRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Makeup":
                    return Character
                        .Parts.Select(i => i.MakeupRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Back":
                    return Character
                        .Parts.Select(i => i.BackRenderer)
                        .Where(i => i != null)
                        .ToList();
                case "Wings":
                    return Character
                        .Parts.Select(i => i.WingsRenderer)
                        .Where(i => i != null)
                        .ToList();
                default:
        ...
        {
            if (
                PlayerPrefs.HasKey(FeedbackTimeKey)
                && (
                    DateTime.UtcNow
                    - new DateTime(long.Parse(PlayerPrefs.GetString(FeedbackTimeKey)))
                ).TotalDays < 14
            )
            {
                return;
            ...
            if (!PlayerPrefs.HasKey(FeedbackRequestTimeKey))
            {
                PlayerPrefs.SetString(
                    FeedbackRequestTimeKey,
                    DateTime.UtcNow.AddHours(-23).Ticks.ToString()
                );
            }
            else if (
                (
                    DateTime.UtcNow
                    - new DateTime(long.Parse(PlayerPrefs.GetString(FeedbackRequestTimeKey)))
                ).TotalDays > 1
            )
            {
                FeedbackTip();
        ...
        protected void RequestFeedbackResult(bool success)
        {
            ...
            else if (PlayerPrefs.HasKey(FeedbackTimeKey))
            {
                PlayerPrefs.SetString(
                    FeedbackRequestTimeKey,
                    DateTime.UtcNow.AddDays(7).Ticks.ToString()
                );
            }
            else
            {

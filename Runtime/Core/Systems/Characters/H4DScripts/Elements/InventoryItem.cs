            ...
            IPointerExitHandler
    {
        ...
        public void Initialize(Item item, ToggleGroup toggleGroup = null)
        {
            ...
            Icon.sprite =
                item.Id == null
                    ? IconEmpty
                    : ItemCollection.Active.GetItemIcon(Item)?.Sprite ?? IconMissed;
            Background.sprite =
                ItemCollection.Active.GetBackground(Item) ?? ItemCollection.Active.BackgroundBrown;
            ...
            if (Modificator)
            {
                ...
                if (mod)
                {
                    ...
                    {
                        case ItemModifier.LevelDown:
                            text = "G-";
                            break;
                        case ItemModifier.LevelUp:
                            text = "G+";
                            break;
                        default:
                            text = Item.Modifier.Id.ToString().ToUpper()[0].ToString();
                            break;
                    }
